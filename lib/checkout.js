...
async function gitCheckoutBeforeAndAfter(gitDir, beforeBranch, afterBranch) {
    ...
    //     debug(`[after] using local cloning because existing checkout already has after branch '${afterBranch}'`);
    ...
    //     }
    // } else {
    //     debug(`[after] using remote cloning, as existing checkout does not have after branch '${afterBranch}'`);
    //     // ...otherwise need to do a full remote clone
