...
function renderAsMarkdown(deltas) {
    let markdown = `📈 [Sizewatcher](https://github.com/adobe/sizewatcher) measured these changes between `;
    markdown += `\`${deltas.before.branch}\` and \`${deltas.after.branch}\` @ ${deltas.after.sha}:\n\n`;
